<template>
  <nav class="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-30 shadow-sm">
    <div class="h-full px-3 sm:px-4 lg:px-6">
      <div class="flex items-center justify-between h-full">
        ...
        <div class="flex items-center space-x-2 sm:space-x-4">
          ...
          <div class="flex items-center space-x-2 sm:space-x-3">
            ...
            <span class="hidden sm:block text-lg sm:text-xl font-bold text-gray-800">Phoenix</span>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
          ...
          <div class="relative" ref="userMenuRef">
            <button
              ...
              class="flex items-center space-x-2 sm:space-x-3 p-1.5 sm:p-2 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
            ...
            >
              ...
              >
                ...
                <div class="px-4 py-3 border-b border-gray-200">
                  ...
                  <p class="text-xs text-gray-500 truncate">{{ user?.phone_no || user?.user_name }}</p>
