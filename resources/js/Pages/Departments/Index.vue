...
const canCreate = computed(() => hasPermission('department_create'));
const canUpdate = computed(() => hasPermission('department_update'));
const canDelete = computed(() => hasPermission('department_delete'));
